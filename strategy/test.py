...
class TestStrategy(BaseStrategy):
    ...
    def __init__(self):
        ...
        self.sma = bt.indicators.SimpleMovingAverage(
            self.datas[0], period=self.params.emaperiod["ema1"]
        )
        #print ("date type: ",type(self.data0.lines.datetime.date(0)))
        #print("time type: ",type(self.data0.lines.datetime.time()))
